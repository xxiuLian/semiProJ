    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/valueSa/resources/smarteditor/file_uploader_html5.jsp'; 	//upload URL
    	//sUploadURL= '/qnaAttachment.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/singleImageUploader.do',	//샘플 URL입니다.
 	        sCallback : '<@=request.getContextPath();@>/resources/sample/smarteditor/sample/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
