...
<style>
    ...
    <%@ include file="../../views/common/menubar.jsp" %>
            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-dark border-bottom">
                    <div class="container-fluid">
                        <button class="btn btn-primary" id="sidebarToggle">My Menu5</button>
		...
		<h2 align="center" style="margin-top:25px;">${loginUser.getUserName()} 님의 참여 상품</h2>
		<br>
		  	...
		  	<tbody>
				<c:choose>
					<c:when test="${empty joinList}">
						<tr>
							<td colspan="5" align="center">공동구매 참여 내역이 없습니다.</td>
						</tr>
					</c:when>
					<c:otherwise>
						<c:forEach items="${joinList}" var="joinList" varStatus="status">
							<tr class="list">
								...
								<td><img src="<%=contextPath%>/assets/img_upfile/${joinList.thumnail}" width="200px" height="200px"></td>
