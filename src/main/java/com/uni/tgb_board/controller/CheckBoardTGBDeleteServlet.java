 ...
 */
@WebServlet("/ChecktgbBoardDelete.do")
public class CheckBoardTGBDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CheckBoardTGBDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0) {
			...
			response.sendRedirect("checkBoardTGBList.do");
		}else {
