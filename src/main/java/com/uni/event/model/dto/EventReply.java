...
public class EventReply {
	...
	public EventReply(int replyId, String replyContent, String replyWriter, Date createDate) {
		super();
	...
	public EventReply(int replyId, String replyContent, int refBoardId, String replyWriter, Date createDate, Date modifyDate,
			String status) {
		super();
		this.replyId = replyId;
		this.replyContent = replyContent;
