...
/**
 * Servlet implementation class QnaManageListServlet
 */
@WebServlet("/adminQnaList.do")
public class QnaManageListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QnaManageListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin/adminQna.jsp").forward(request, response);	
